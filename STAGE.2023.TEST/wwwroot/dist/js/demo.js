...
(function ($) {
  ...
  setTimeout(function () {
      if (window.___browserSync___ === undefined && Number(localStorage.getItem('Welcome From Monta!!!')) < Date.now()) {
          localStorage.setItem('Welcome From Monta!!!', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      alert('Welcome From Monta!!!')
    }
  }, 1000)
  ...
  $container.append(
    '<h5>Customize Dev Tasks</h5><hr class="mb-2"/>'
  )
